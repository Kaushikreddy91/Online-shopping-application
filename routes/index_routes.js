...
router.get('/Seeds/HerbSeeds', (req, resp) => {
    ...
    var k = "SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;"
    con.query(k, [34,35,36,37], function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/HerbSeeds.ejs', {data: data,userId:userId});
    });
})

router.get('/Seeds/HerbSeeds/OrganicSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=34"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/OrganicSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/OrganicSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/HerbSeeds/OrganicSeeds');
        }
    });
});

router.get('/Seeds/HerbSeeds/HybridSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=35"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/HybridSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/HybridSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/HerbSeeds/HybridSeeds');
        }
    });
});

router.get('/Seeds/HerbSeeds/ExoticVegSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=36"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/ExoticVegSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/ExoticVegSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/HerbSeeds/ExoticVegSeeds');
        }
    });
});

router.get('/Seeds/HerbSeeds/MicrogreenSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=37"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/MicrogreenSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/MicrogreenSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/HerbSeeds/MicrogreenSeeds');
        }
    });
});
//-------------------------------------------------------------------------------------------------------------------
...
router.get('/Seeds/FloweringSeeds', (req, resp) => {
    ...
    var a = "SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;"
    con.query(a, [38,39,40], function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/FloweringSeeds.ejs', {data: data,userId:userId});
    });
})

router.get('/Seeds/FloweringSeeds/OPPlantSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=38"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/OPPlantSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/OPPlantSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/FloweringSeeds/OPPlantSeeds');
        }
    });
});

router.get('/Seeds/FloweringSeeds/ImportedSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=39"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/ImportedSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/ImportedSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/FloweringSeeds/ImportedSeeds');
        }
    });
});

router.get('/Seeds/FloweringSeeds/FragrantSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=40"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/FragrantSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/FragrantSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/FloweringSeeds/FragrantSeeds');
        }
    });
});
...
router.get('/Seeds/ForestrySeeds', (req, resp) => {
    ...
    var b = "SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;"
    con.query(b, [41,42,43], function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/ForestrySeeds.ejs', {data: data,userId:userId});
    });
})

router.get('/Seeds/ForestrySeeds/MedicinalTreeSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=41"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/MedicinalTreeSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/MedicinalTreeSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/ForestrySeeds/MedicinalTreeSeeds');
        }
    });
});

router.get('/Seeds/ForestrySeeds/BambooSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=42"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/BambooSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/BambooSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/ForestrySeeds/BambooSeeds');
        }
    });
});

router.get('/Seeds/ForestrySeeds/PalmTreeSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=43"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/PalmTreeSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/PalmTreeSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/ForestrySeeds/PalmTreeSeeds');
        }
    });
});
...
router.get('/Seeds/OtherSeeds', (req, resp) => {
    ...
    var c = "SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;SELECT products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=? LIMIT 3;"
    con.query(c, [44,45], function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/OtherSeeds.ejs', {data: data,userId:userId});
    });
})

router.get('/Seeds/OtherSeeds/GrassSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=44"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/GrassSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/GrassSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/OtherSeeds/GrassSeeds');
        }
    });
});
...
router.get('/Seeds/OtherSeeds/FruitSeeds', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=45"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/Seeds/FruitSeeds.ejs', {data: data,userId:userId});
    });
})
router.post('/FruitSeeds/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/Seeds/OtherSeeds/FruitSeeds');
        }
    });
});
...
router.get('/SoilAndFertilizer/PottingSoilMixes', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=46"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/SoilAndFertilizer/PottingSoilMixes.ejs', {data: data,userId:userId});
    });    
})
router.post('/PottingSoilMixes/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/SoilAndFertilizer/PottingSoilMixes');
        }
    });
});
...
router.get('/SoilAndFertilizer/Fertilizer', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=47"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/SoilAndFertilizer/Fertilizer.ejs', {data: data,userId:userId});
    });  
})
router.post('/Fertilizer/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/SoilAndFertilizer/Fertilizer');
        }
    });
});
...
router.get('/SoilAndFertilizer/SoilAmendments', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=48"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/SoilAndFertilizer/SoilAmendments.ejs', {data: data,userId:userId});
    }); 
})
router.post('/SoilAmendments/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/SoilAndFertilizer/SoilAmendments');
        }
    });
});
...
router.get('/SoilAndFertilizer/SeedStartingSoils', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=49"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/SoilAndFertilizer/SeedStartingSoils.ejs', {data: data,userId:userId});
    }); 
})
router.post('/SeedStartingSoils/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/SoilAndFertilizer/SeedStartingSoils');
        }
    });
});
...
router.get('/PestsADC/FencesandBarriers', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=50"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/PestsADC/FencesandBarriers.ejs', {data: data,userId:userId});
    });    
})
router.post('/FencesandBarriers/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/PestsADC/FencesandBarriers');
        }
    });
});


router.get('/PestsADC/AnimalControls', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=51"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/PestsADC/AnimalControls.ejs', {data: data,userId:userId});
    });    
})
router.post('/AnimalControls/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/PestsADC/AnimalControls');
        }
    });
});


router.get('/PestsADC/InsectControls', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=52"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/PestsADC/InsectControls.ejs', {data: data,userId:userId});
    });    
})
router.post('/InsectControls/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/PestsADC/InsectControls');
        }
    });
});


router.get('/PestsADC/PlantDiseaseControls', (req, resp) => {
    var userId = req.session.userId;
    var j = "SELECT products.product_id,products.product_name,products.Prod_image,products.price,products.review,category.Category_name FROM products JOIN category ON products.Category_Id=category.Category_Id WHERE products.Category_Id=53"
    con.query(j, function (err, result, fields) {
        if (err) throw err;
        var data = result;
        resp.render('../views/PestsADC/PlantDiseaseControls.ejs', {data: data,userId:userId});
    });    
})
router.post('/PlantDiseaseControls/:id', function (req, resp) {
    var userId = req.session.userId;
    if (userId == null) {
        resp.redirect("/login");
        return;
    ...
    con.query('INSERT INTO cart_item SET ?', p, function (error, results) {
        if (error) {
            ...
            resp.redirect('/PestsADC/PlantDiseaseControls');
        }
    });
});
